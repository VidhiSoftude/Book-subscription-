  ...
  return (
    <>
          ...
          <ul>
            ...
            <li>
            <button className='nav-btn'> <Link to ="/login"  className={splitLocation[1] === "login" ? "active" : ""}> Login</Link></button>
            </li>
            <li>
            <button className='nav-btn'> <Link to ="/signup"  className={splitLocation[1] === "signup" ? "active" : ""}>Signup</Link></button>
            </li>
            <li>
            <button className='nav-btn'> <Link to ="/signup"  className={splitLocation[1] === "signup" ? "active" : ""}> Signup</Link></button>
            </li>
